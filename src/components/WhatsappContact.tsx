...
export default function WhatsappContact() {
    ...
    // TAW 10 Brand Colors
    const primaryColor = "#1a365d"; // Primary Dark Blue
    const secondaryColor = "#d4af37"; // Secondary Gold

    const t = {
        title: "Support TAW 10",
        status: "En ligne",
        description: "Bonjour ! Nos experts sont à votre disposition. Comment pouvons-nous vous accompagner aujourd'hui ?",
        ...
        <>
                ...
                {isOpen && (
                    ...
                    >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs text-white/60 uppercase tracking-widest font-bold">{t.status}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-7 space-y-5">
                            <p className="text-slate-500 text-sm leading-relaxed font-light">{t.description}</p>
                            <a
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">{t.role}</span>
                                    </div>
                                </div>
            ...
            <AnimatePresence>
                {!isOpen && (
                    ...
                    >
                        <div className="text-primary font-bold text-sm tracking-tight">{t.tooltip_title}</div>
                        <div className="text-slate-500 text-[10px] uppercase tracking-wider font-bold opacity-60">{t.tooltip_sub}</div>
                        {/* Triangle decorator */}
